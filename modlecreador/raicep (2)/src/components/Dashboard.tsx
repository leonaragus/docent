...
import { UserState, TallerVivo, Course, ThemePreset, Academy } from '../types';
import { 
  Zap, 
  Calendar, 
  Sparkles, 
...
export default function Dashboard({
  ...
  return (
    <div className="space-y-8 my-4 text-left">
      ...
      {/* 1. BRANDING INSTITUTIONAL HEADING BANNER (RAICEP OFFICIAL INTEGRATION) */}
      <div 
      ...
      >
        ...
        <div className="pl-4 md:pl-6 space-y-4 max-w-3xl">
          ...
          <div className="flex flex-wrap gap-3 items-center pt-2 text-[11px] font-sans">
            ...
            <span className={`flex items-center gap-1 px-3 py-1 rounded-full font-semibold border ${activeAcademy.bannerUrl ? 'bg-slate-800/65 text-slate-200 border-indigo-500/30' : 'bg-slate-50 text-slate-500 border-slate-200'}`}>
              ...
              Certificación con Firma Digital RAICEP
            </span>
            <span className={`flex items-center gap-1 px-3 py-1 rounded-full font-semibold border ${activeAcademy.bannerUrl ? 'bg-slate-800/65 text-slate-200 border-indigo-500/30' : 'bg-slate-50 text-slate-500 border-slate-200'}`}>
              <Building2 className="w-3.5 h-3.5 text-slate-400" />
              Academia Certificada: https://{activeAcademy.subdomain}.raicep.app
            </span>
          </div>
        </div>
        ...
        <div className="bg-slate-50 p-6 rounded-2.5xl border border-slate-200/80 text-center w-full md:w-56 space-y-3 shrink-0 flex flex-col justify-center items-center">
          {activeAcademy.logoUrl ? (
            ...
            /* Fallback automatically to RAICEP's validation badge */
            <div className="relative">
              ...
              <span className="absolute -bottom-1 -right-1 w-5 h-5 bg-amber-500 rounded-full border border-white flex items-center justify-center text-[9px] text-slate-905 font-bold shadow-xs select-none" title="Sello RAICEP Heredado">
                ★
              </span>
            </div>
          )}
          <div>
            ...
            <span className="text-[9px] text-slate-400 block italic leading-none mt-1">
              {activeAcademy.logoUrl ? 'Identidad Personalizada' : 'Usando Sello RAICEP'}
            </span>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-slate-100 pb-5">
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-500 font-sans">
              Selecciona e ingresa al programa de estudio aprobado bajo directiva RAICEP para cursar módulos prácticos y agendar talleres en vivo.
            </p>
          </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-2 border-t border-slate-100 pt-3 text-[10px] text-slate-500 font-sans">
                      ...
                      <div>
                        ...
                        <span className="font-bold text-indigo-650 block mt-0.5">Analítica RAICEP</span>
                      </div>
                    </div>
                  </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
              <div className="space-y-1">
                ...
                <h4 className="font-bold text-sm sm:text-base text-slate-100 leading-snug">
                  Módulo de Homologación de Cátedra & Firmado Digital RAICEP
                </h4>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-xs mt-0.5">Sede virtual privada integrada en el Nodo Evaluador RAICEP</p>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 bg-white border border-slate-150 rounded-3xl p-6 shadow-xs space-y-6">
            <div>
              ...
              <p className="text-xs text-slate-550 mt-1 font-sans">
                Tus entregas evaluadas por mentores forman parte de tu expediente analítico homologado en RAICEP.
              </p>
            </div>
                  ...
                  >
                    ...
                    {sub.feedback ? (
                      ...
                      <div className="bg-amber-50/20 p-3 rounded-xl border border-dashed border-amber-200 text-xs text-amber-800">
                        ⌛ Evaluando evidencias bajo norma RAICEP.
                      </div>
                    )}
                  </div>
                ))
