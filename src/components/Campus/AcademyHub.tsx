...
import { Academy, ThemePreset } from '../campusTypes';
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[10px] text-slate-450 font-mono truncate leading-normal">
                             https://{acad.subdomain}.docent.app
                          </p>
                        </div>
                      </button>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-slate-400 italic">
                    Dirección privada simulada: <span className="font-semibold text-indigo-600">https://{newSubdomain || 'subdominio'}.docent.app</span>
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  <label className="text-[11px] font-extrabold text-slate-600 uppercase tracking-widest block font-sans flex items-center justify-between">
                    ...
                    <span className="text-[9px] text-slate-400 font-bold font-sans">Se hereda escudo docent si está vacío</span>
                  </label>
