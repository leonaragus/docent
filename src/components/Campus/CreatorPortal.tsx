...
import { Course, Module, TallerVivo, Submission, UserState, Academy, RecordedClass } from '../campusTypes';
import { 
  PlusCircle, 
  MapPin, 
  BookOpen, 
      ...
      <div className="lg:col-span-4 space-y-6">
        ...
        <div className="bg-gradient-to-br from-indigo-900 to-violet-950 text-white rounded-3xl p-6 shadow-md relative overflow-hidden">
          ...
          <p className="text-xs text-slate-200 leading-relaxed font-sans mb-4">
            Aquí diseñas el ecosistema educativo. A diferencia de otros sistemas clásicos que requieren configuraciones burocráticas aburridas, en **docent** la acreditación y creación es instantánea, privada y transparente.
          </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 flex items-center justify-between">
                    ...
                    <span className="text-[9px] font-mono text-emerald-600 lowercase font-bold">docent virtual</span>
                  </label>
          ...
          <div className="bg-white border-8 border-indigo-950 rounded-3xl p-6 sm:p-10 max-w-2xl w-full text-center relative shadow-2xl font-serif space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-[11px] text-slate-400 max-w-md mx-auto font-sans leading-relaxed">
                Emitido bajo los lineamientos pedagógicos del Sistema de Homologación Institucional y Certificación Profesional docent, con validez curricular.
              </p>
            </div>
