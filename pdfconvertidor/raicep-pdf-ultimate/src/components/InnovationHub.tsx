    ...
    <div id="innovation-hub-section" className="space-y-6 relative pt-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-display font-semibold text-white tracking-tight flex items-center gap-2">
            Faro de Innovación <span className="text-xs bg-white/5 border border-white/10 text-slate-300 px-2 py-0.5 rounded-full font-mono font-medium">10 IDEAS DE FUTURO</span>
          </h2>
      ...
      {toastMessage && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -20 }}
          className="backdrop-blur-md bg-white/5 border border-indigo-500/30 text-indigo-300 text-xs py-3 px-4 rounded-xl shadow-[0_0_15px_rgba(99,102,241,0.2)] flex items-center justify-between"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {ideas.map((idea) => (
          <div
            ...
            className="p-5 rounded-2xl backdrop-blur-md bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all duration-300 flex flex-col justify-between gap-4 group relative overflow-hidden"
          >
