...
export default function FacebookPostPreview({ variation, courseTitle, courseFormat }: FacebookPostPreviewProps) {
  ...
  return (
    <div id="facebook-post-preview" className="bg-slate-50 p-4 rounded-2xl border border-slate-200 flex flex-col gap-4">
      ...
      <div className="flex justify-center transition-all">
        <div
          className={`bg-white rounded-lg border border-slate-350 shadow-sm text-left transition-all ${
        ...
        >
          ...
          <div className="p-3.5 flex items-start justify-between">
            <div className="flex items-center gap-2.5">
              {/* Fake Page Avatar */}
              <div className="w-10 h-10 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-700 font-bold text-sm select-none">
            ...
            <div className="text-slate-400 font-bold hover:bg-slate-100 p-1 rounded-full w-8 h-8 flex items-center justify-center cursor-pointer text-sm">
              •••
            </div>
          </div>
          ...
          <div className="px-3.5 pb-2.5 text-[14px] text-[#050505] leading-[1.4] whitespace-pre-wrap selection:bg-indigo-100 break-words">
            <p className="font-bold text-[15px] text-slate-900 mb-1.5">{variation.hook}</p>
          ...
          <div className="border-t border-b border-slate-200 bg-slate-50 cursor-pointer overflow-hidden transition-all hover:bg-slate-100">
            ...
            <div className="aspect-video w-full bg-slate-900 p-6 flex flex-col justify-between relative text-white">
              <div className="absolute top-3 left-3 bg-white/10 backdrop-blur-md px-2.5 py-1 rounded-full text-[10px] font-semibold uppercase tracking-wider border border-white/20">
                🏷️ {courseFormat || "Inscripción Abierta"}
              </div>
              <div className="mt-8 flex-1 flex flex-col justify-center">
                <h3 className="text-lg md:text-xl font-extrabold tracking-tight leading-snug drop-shadow-sm line-clamp-2 max-w-xs font-display">
                  {courseTitle}
                </h3>
                <p className="text-[11px] text-slate-300 drop-shadow-xs line-clamp-1 mt-1 max-w-xs">
              ...
              <div className="flex items-center justify-between border-t border-white/10 pt-2.5 mt-2">
                ...
                <span className="text-[11px] font-bold bg-white text-slate-900 px-3 py-1 rounded shadow-xs flex items-center gap-1">
                  Inscribirse
                </span>
              </div>
            </div>
            ...
            <div className="bg-[#f0f2f5] p-3 flex items-center justify-between border-t border-[#e4e6eb]">
              ...
              <button className="flex-none bg-[#e4e6eb] hover:bg-[#d8dadf] text-[#050505] font-bold py-1.5 px-3.5 rounded-md text-xs select-none transition-colors border border-slate-350 shadow-xs">
                Más información
              </button>
            </div>
          </div>
          ...
          <div className="px-3.5 py-2 flex items-center justify-between text-[13px] text-[#65676b] border-b border-[#e4e6eb]">
            <div className="flex items-center gap-1">
              <span className="flex items-center justify-center w-5 h-5 rounded-full bg-indigo-600 border-2 border-white select-none shadow-xs">
      ...
      <div className="bg-white border border-slate-200 p-4 rounded-xl text-left shadow-xs">
        ...
        <p className="text-xs text-slate-500 leading-relaxed italic border-l-2 border-indigo-500 pl-2.5">
