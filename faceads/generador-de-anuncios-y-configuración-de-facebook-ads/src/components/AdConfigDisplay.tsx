  ...
  return (
    <div className="flex flex-col gap-6 text-left" id="ads-planner-display">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white border border-slate-205 rounded-xl p-5 shadow-xs flex flex-col justify-between">
          <div>
            <div className="w-8 h-8 bg-slate-100 text-slate-800 rounded-lg flex items-center justify-center mb-3">
              <Target size={16} />
            </div>
            <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-wider font-display">Objetivo en Meta</h4>
            <p className="text-base font-bold text-slate-900 mt-1">{config.objective}</p>
          </div>
        ...
        <div className="bg-white border border-slate-205 rounded-xl p-5 shadow-xs flex flex-col justify-between">
          <div>
            ...
            <p className="text-base font-bold text-slate-900 mt-1">{config.conversionLocation}</p>
          </div>
          <p className="text-xs text-slate-500 mt-2 border-t border-slate-100 pt-2 leading-relaxed">
        ...
        <div className="bg-white border border-slate-205 rounded-xl p-5 shadow-xs flex flex-col justify-between">
          <div>
            ...
            <p className="text-base font-bold text-slate-900 mt-1">{config.estimatedBudget}</p>
          </div>
          <p className="text-xs text-slate-500 mt-2 border-t border-slate-100 pt-2 leading-relaxed">
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-xl p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-4 rounded-lg border border-slate-200 relative">
            ...
            <p className="text-xs font-semibold text-slate-800 pr-8">{config.demographics.locations}</p>
            <button
          ...
          <div className="bg-white p-4 rounded-lg border border-slate-200">
            ...
            <p className="text-xs font-semibold text-slate-800">{config.demographics.ageRange}</p>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg border border-slate-200">
            ...
            <p className="text-xs font-semibold text-slate-800">{config.demographics.genders}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {config.interestsToTarget.map((item, index) => (
            <div key={index} className="border border-slate-200 hover:border-slate-350 rounded-lg p-4 transition-all relative group bg-slate-50/40">
              <div className="flex items-center justify-between pr-8">
                <span className="inline-block bg-white text-slate-800 text-[11px] font-bold px-2.5 py-1 rounded border border-slate-250 font-mono tracking-wide">
                  {item.interest}
                </span>
                <button
                  onClick={() => copyToClipboard(item.interest, `interest-${index}`)}
                  className="absolute top-4 right-4 text-slate-400 hover:text-slate-600 transition-opacity cursor-pointer"
              ...
              <p className="text-xs text-slate-500 mt-2.5 leading-relaxed border-t border-slate-100 pt-2">
                <strong className="text-slate-700 block text-[9px] uppercase tracking-wider mb-0.5">Razón Estratégica:</strong>
                {item.reason}
              </p>
            </div>
          ))}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-5">
          ...
          <div className="bg-white p-2.5 rounded border border-slate-200 mt-3 text-[11px] text-slate-500 italic">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-5">
          ...
          <div className="bg-white p-2.5 rounded border border-slate-200 mt-3 text-xs">
